    ...
    const ContactData = [
        {
            id: 1,
            title: "Email Us",
            info: 'Have questions or suggestions? We’d love to hear from you.',
            icon: FiMail,
            contact: 'Cinemate@gmail.com',
        },
        {
            id: 2,
            title: "Call Us",
            info: 'Get in touch for support or inquiries — we are here to help.',
            icon: FiPhoneCall,
            contact: '+963 955 555 555',
        },
        {
            id: 3,
            title: "Location",
