          ...
          <div className="col-span-3 flex items-center justify-start">
            ...
            >
              ...
              <input
                ...
                className="bg-beige font-medium placeholder:text-border text-sm h-10 bg-lightGray rounded-xl px-4 text-black focus:outline-none focus:ring-2 focus:ring-beige transition-all duration-300 w-full pointer-events-none"
              />
            </form>
          </div>
